 ...
 *
 * Loss scheme: water molecule as projectile and carbon ion as target
 *
 * A = re - rt (R2)
 * B = rp - rt (R1)
 * C = re - rp (R3)
...
public class LossScheme {
    ...
    public LossScheme(RecGenerator.Orbital orb, double KE, double b, Particle.ParticleName carbon_ion) {
        t = new Particle(carbon_ion);
        p = new Particle(Particle.ParticleName.WATER);
        e = new Electron();
    ...
    public void initialize(RecGenerator RGen, Random rand1, Random rand2, Random rand3) {
        ...
        double vpx0 = 0;
        double vpy0 = 0;
        double vpz0 = Math.sqrt((2*KE)/t.m);
